...
public class AbstractBeanFactory implements BeanFactory{
	...
	public void preInstantiateSingletons() throws Exception {
		...
		while (it.hasNext()) {
			...
			System.out.println("在AbstractBeanFactory中调用preInstantiateSingletons预处理bean--------->"+beanName.toString()+"的方法");
			getBean(beanName);
		}
	}
	...
	public void registerBeanDefinition(String name, BeanDefinition beanDefinition) throws Exception {
		...
		System.out.println("把bane的名字---->"+name.toString()+"和bean的BeanDefinition信息都放到线程安全的Map集合中------>"+beanDefinition.toString());
	}
